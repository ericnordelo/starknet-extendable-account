...
mod AccountComponent {
    use ex_account::account::interface::IExtendableAccount;
    use ex_account::library_call::LibraryCall;
    use ex_account::account::utils::execute_safe_plugin_library_calls;
    ...
    #[embeddable_as(ExtendableAccountImpl)]
    impl ExtendableAccount<
        TContractState,
        +SafePlugins,
        +HasComponent<TContractState>,
        +SRC5Component::HasComponent<TContractState>,
        +Drop<TContractState>
    > of IExtendableAccount<ComponentState<TContractState>> {
        ...
        fn __execute__(
            ...
            library_calls: Array<LibraryCall>
            ...
            (execute_calls(calls), execute_safe_plugin_library_calls(library_calls))
        }
        ...
        fn __validate__(
            self: @ComponentState<TContractState>,
            mut calls: Array<Call>,
            mut library_calls: Array<LibraryCall>
        ) -> felt252 {
    ...
    #[embeddable_as(ExtendableAccountCamelOnlyImpl)]
    impl ExtendableAccountCamelOnly<
        TContractState,
        +SafePlugins,
        +HasComponent<TContractState>,
        +SRC5Component::HasComponent<TContractState>,
